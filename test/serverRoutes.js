...
tap.test("\nRouting",function (t) {
  t.plan(4);
  var client1 = restify.createJsonClient({ url: 'https://127.0.0.1:8080', headers: { 'Authorization':basicAuthServer,'Accept':"application/json",'Content-Type':"application/json" }});
  ...
  var client2 = restify.createJsonClient({ url: 'https://127.0.0.1:8080', headers: { 'Authorization':basicAuthClient,'Accept':"application/json",'Content-Type':"application/json" }});
  ...
  var client3 = restify.createJsonClient({ url: 'https://127.0.0.1:8080', headers: { 'Accept':"application/json",'Content-Type':"application/json" }});
  ...
  var client4 = restify.createJsonClient({ url: 'https://127.0.0.1:8080', headers: { 'Accept':"application/json",'Content-Type':"application/json" }});
...
tap.test("\nAuthentications",function (t) {
  ...
  var client2 = restify.createJsonClient({ url: 'https://127.0.0.1:8080', headers: { 'Authorization':'hey oh','Accept':"application/json",'Content-Type':"application/json" }});
  ...
  var client3 = restify.createJsonClient({ url: 'https://127.0.0.1:8080', headers: { 'Authorization':'Basic c2FtcGxlOnRleHQ=','Accept':"application/json",'Content-Type':"application/json" }});
  ...
  var client4 = restify.createJsonClient({ url: 'https://127.0.0.1:8080', headers: { 'Authorization':basicAuthServer,'Accept':"application/json",'Content-Type':"application/json" }});
  client4.post("/register/",{ hello: 'world' },function (err,req,res,obj) {
    t.equal(res.statusCode,204,"(204) Allow server credentials accessing client route. (no properly body)");
  });
  var client5 = restify.createJsonClient({ url: 'https://127.0.0.1:8080', headers: { 'Authorization':basicAuthClient,'Accept':"application/json",'Content-Type':"application/json" }});
