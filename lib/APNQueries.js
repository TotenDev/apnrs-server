...
**/
APNQueries.prototype.createPushMessageLog = function createPushMessageLog(connection,msg_alert,msg_sound,msg_badge,isBroadcasting,tags,deviceToken,sentDate,callback) {
  var strQuery = util.format('INSERT INTO %s (msg_alert,msg_sound,msg_badge,isBroadcasting,tags,deviceToken) VALUES (\'%s\',\'%s\',\'%s\',\'%s\',\'%s\',\'%s\',\'%s\') ',APNPushMessagesDatabaseMysqlKey,msg_alert,msg_sound,msg_badge,isBroadcasting,tags,deviceToken,status);
