...
APNDevice.prototype.defaultDatabaseConnection = function defaultDatabaseConnection(successCb,errorCB) {
  ...
  var mysqlOptions = { host:this.databaseInformations['host'],user:this.databaseInformations['user'],password:this.databaseInformations['password'],database:this.databaseInformations['database'] };
 ...
 this.defaultDatabaseConnection(function (connection) {
   ...
   if (!responsed) {
    ...
    connection.query(strQuery, function(err, rows, fields) {
     console.log('query result: ', rows,"----",err,"----",fields);
    });
   }
  },function (err) {
  //Cannot connect
