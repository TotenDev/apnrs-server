...
**/
APNDeviceDB.prototype.createUpdate = function createUpdate(connection,active,token,tags,startDateGMT,endDateGMT,deviceBadge,callback) {
...
* @param String callback.resp - response string|obj when convinient.
**/
APNDeviceDB.prototype.unregister = function unregister(connection,token,callback) {
...
* 
**/
APNDeviceDB.prototype.listDevices = function listDevices(connection,order,callback) {
...
* 
**/
APNDeviceDB.prototype.listActiveDevices = function listActiveDevices(connection,order,callback) {
...
* 
**/
APNDeviceDB.prototype.listActiveDevicesWithTags = function listActiveDevicesWithTags(connection,tags,callback) {
  var instance = this;
...
* @param String callback.resp - response string|obj when convinient.
**/
APNDeviceDB.prototype.logRegister = function logRegister(connection,deviceID,registering,callback) {
...
* 
**/
APNDeviceDB.prototype.listRegisterCalls = function listRegisterCalls(connection,startDate,endDate,callback) {
...
* @param String callback.resp - response string|obj when convinient.
**/
APNDeviceDB.prototype.createUpdateTags = function createUpdateTags(connection,tags,callback) {
  var current = 0, 
...
* @param String callback.resp - response string|obj when convinient.
**/
APNDeviceDB.prototype.associateDeviceWithTag = function associateDeviceWithTag(connection,deviceID,tagIDs,callback) {
...
* @param String callback.resp - response string|obj when convinient.
**/
APNDeviceDB.prototype.associatedDevicesWithTagsID = function associatedDevicesWithTagsID(connection,tagIDs,callback) {
...
* @param String callback.resp - response string|obj when convinient.
**/
APNDeviceDB.prototype.cleanTagsOfDevice = function cleanTagsOfDevice(connection,deviceID,callback) {
  if (deviceID) {
...
* @param String callback.resp - response string|obj when convinient.
**/
APNDeviceDB.prototype.cleanUnusedTags = function cleanUnusedTags(connection,callback) {
...
* 
**/
APNDeviceDB.prototype.listFullTagsByName = function listFullTagsByName(connection,order,tags,callback) {
  //Get tags WHERE clause
  var tagsQuery = '';
  for (tag in tags) {
...
* 
**/
APNDeviceDB.prototype.listTags = function listTags(connection,order,callback) {
