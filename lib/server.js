...
APNRestServer.prototype.startRestServer = function startRestServer() {
  var serverOptions = { name:"APNRS" };
  if (APNRestServerInstance.restCertificate && APNRestServerInstance.restPrivateKey) {
    serverOptions['certificate'] = APNRestServerInstance.restCertificate;
    serverOptions['key'] = APNRestServerInstance.restPrivateKey;
  }
  APNRestServerInstance.server = server = restify.createServer(serverOptions);
